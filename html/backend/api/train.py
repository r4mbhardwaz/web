...
from jarvis import MQTT, Jarvis


@app.route("/api/assistant/status")
@login_required
def api_assistant_status():
    result = Jarvis.api("jarvis/satellite/nlu/status", {}, 2)
...
def api_assistant_parse():
    ...
    result = Jarvis.api("jarvis/satellite/nlu/parse", {"utterance": json_data["utterance"]}, 2)
